...
@app.callback(
    ...
    [Input(component_id='Recession Period Statistics', component_property='value'), Input(component_id='dropdown-statistics', component_property='value')])


def update_output_container(selected_statistics, dropdown_stat):
    if dropdown_stat == 'Recession Period Statistics':
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="verage Number of Vehicles Sold by Vehicle Type"))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby('Vehicle_Type')
        R_chart4 = dcc.Graph(figure=px.bar(unemp_data, x='Vehicle_Type', y='Automobile_Sales', 
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    elif (input_year and selected_statistics=='selected_year') :
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
         # grouping data for plotting.
         # Hint:Use the columns Year and Automobile_Sales
        avr_vdata = yearly_data[yearly_data['Year'] == input_year].groupby('Vehicle_Type')['Automobile_Sales'].mean().reset_index()
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(id='total-advertisement-expenditure',
